...
object NotificationHelper {
    ...
    fun buildAlarmNotification(
        ...
        // Intentionally no sender/phone number in the notification content —
        // just the keyword, so nothing identifying shows on the lock screen
        // or in the notification shade.
        val contentMsg = "Keyword: \"$keyword\""
